function [Y] = Rotation_ForceMoment_ToVehicleFixed(X,A_K_F)
%% Input parameters:
...
% Quarter Vehicle Model along Rear Axle Fixed z-Axis: Rotation from RearAxleFixed Coordinate System into VehicleFixed Coordinate System
Y=[(A_K_F*X(:,1)) (A_K_F*X(:,2)) (A_K_F*X(:,3)) (A_K_F*X(:,4))];
