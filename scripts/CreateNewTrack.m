...
rlObj_val.s_m = inM(1:dist:end,1);
...
rlObj_val.ValidPointCnt = length(inM(1:dist:end,1));
rlObj_val.s_m_end = rlObj_val.s_m(length(inM(1:dist:end,1)));
...
addEntry(dDataSectObj,'Raceline_Op2',...
    struct('s_m',rlObj_val.s_m,'x_m',rlObj_val.x_m,'y_m',rlObj_val.y_m,...
        ...
        'ax_mps2',rlObj_val.ax_mps2,'delta_rad',rlObj_val.delta_rad,'F_N',rlObj_val.F_N,...
        'ValidPointCnt',rlObj_val.ValidPointCnt,'s_m_end',rlObj_val.s_m_end));
addEntry(dDataSectObj,'s0_m_Op1',0);
addEntry(dDataSectObj,'s0_m_Op2',0);
addEntry(dDataSectObj,'s0_m_Op3',0);
addEntry(dDataSectObj,'s0_m_Op4',0);
...
addEntry(dDataSectObj,'x0_vehiclepose',...
